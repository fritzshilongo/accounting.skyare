...
return [
    ...
    */
    ...
    'driver' => (static function (): string {
        ...
        return is_string($driver) && trim($driver) !== '' ? $driver : 'file';
    })(),
    ...
    */
    ...
    'domain' => (static function (): ?string {
        ...
        if (is_string($baseDomain) && trim($baseDomain) !== '') {
            $baseDomain = ltrim(trim($baseDomain), '.');
    ...
    */
    ...
    'secure' => (static function (): bool {
        ...
        if ($secure === null || $secure === '' || strtolower((string) $secure) === 'null') {
            return false;
        }
    ...
    */
    ...
    'same_site' => (static function (): ?string {
        ...
        return is_string($sameSite) && trim($sameSite) !== '' ? $sameSite : 'lax';
    })(),
